...
client: UI_Interface.o controller.o BJD.o BJP.o chat_client.o
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) -o client UI_Interface.o controller.o BJD.o BJP.o chat_client.o $(GTKFLAGS) -g -Wall

chat_client.o : src/chat_client.cpp include/chat_message.hpp include/client.h
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) -c $< -lpthread $(GTKFLAGS) -g -Wall 

UI_Interface.o : src/UI_Interface.cpp include/*.h
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) -c src/UI_Interface.cpp $(GTKFLAGS) -g -Wall

controller.o : src/controller.cpp include/*.h
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) -c src/controller.cpp $(GTKFLAGS) -g -Wall

BJD.o : src/BJD.cpp include/*.h
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) -c src/BJD.cpp $(GTKFLAGS) -g -Wall

BJP.o : src/BJP.cpp include/*.h
	$(CXX) $(CXXFLAGS) $(CPPFLAGS) -c src/BJP.cpp $(GTKFLAGS) -g -Wall
