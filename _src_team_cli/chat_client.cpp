...
int main(int argc, char* argv[])
{
    try
    {
        ...
        std::cout << "\nAre you ready to join?" << std::endl;
        char ans;
        std::cout << "Join and Play? press y" << std::endl;
        std::cin >> ans;
        ...
        while(ans == 'y')
        {
                ...
                std::cout << "Do you want to hit? press h" << std::endl;
                std::cin >> ans;
                
                std::cerr << "hit button pressed: " << std::endl;
                //chat_message msg;
                msg.body_length (0);
                msg.ca.hit = true;
                msg.ca.stand = false;
            ...
            std::cout << "play next round? press y" << std::endl;
            std::cin >> ans;
        }
